const sounds = ['Birds', "River-water", 'Applause', 'Boo', 'Yay', 'Tada' ,'Victory', 'Wrong', 'Alarm','BuDumTss', 'Woof','Laugh','TskTsk','Sneeze', 'Orchestra','Yawn', 'Trumpets', 'Crunch', 'Mystery', 'WarHorn', 'Thunder', 'Horror']
